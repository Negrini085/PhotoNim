...
let 
    timeStart = cpuTime()
    outFile = "assets/images/examples/teapot"
    ...
    comp = newComposition(newScaling(0.05), newRotZ(90), newRotX(90))
    teapot = newMesh("assets/meshes/teapot.obj", transformation = comp, treeKind = tkBinary, maxShapesPerLeaf = 10, rgState = 42, rgSeq = 2)
