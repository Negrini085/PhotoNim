...
let 
    ...
    comp2 = newComposition(newScaling(0.01), newRotX(90))

    trumpet = newMesh("assets/meshes/trumpet.obj", transformation = comp2, treeKind = tkBinary, maxShapesPerLeaf = 10, rgState = 42, rgSeq = 2)
